...
|------|-------------|-------|
| Infrastructure | Clean environment starts the stack | M1 |
...
M0 closes the four infrastructure rows and the safety-configuration rows. The
rest are open by design.
